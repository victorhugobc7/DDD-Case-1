...
namespace Domain.Solicitacao;

public class AuthorizationRequest : AggregateRoot
{
    ...
    public CidCode CidCode { get; private set; }
    ...
    public AuthorizationRequest(Guid id, Guid beneficiaryId, PlanNumber planNumber, ProcedureCode procedureCode,
        CidCode cidCode, ProfessionalRegistry requestingProfessional, string executingEstablishment,
        ...
        : base(id)
    {
        ...
        if (cidCode == null)
            throw new ArgumentNullException(nameof(cidCode));
